...
const SongCard = ({ title, artists, genres, songFile }) => {
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg m-4 bg-[#5257cd] bg-opacity-15 border-2 border-[#4a92de] border-t-[#034f74] border-r-[#034f74] border-b-[#5257cd]">
